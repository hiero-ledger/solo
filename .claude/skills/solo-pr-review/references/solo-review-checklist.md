...
**Prior precedent:** PR #3939 (jdwp\_tester.py, jdwp-tester.ts missing license).
...
**Prior precedent:** PR #3390 (LISTR\_DEFAULT\_OPTIONS in 3 files).
...
was updated. See CLAUDE.md "Environment Variable Documentation" for the SOLO\_\* naming convention.
