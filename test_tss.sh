...
npm run solo-test -- consensus network deploy --deployment "${SOLO_DEPLOYMENT}" -i "${NODE_ALIASES}" --tss --application-properties test/data/tss-mock-signatures.properties
