...
Browse the source code and configuration files for this example in the [GitHub repository](https://github.com/hiero-ledger/solo/tree/main/examples/node-update-transaction).
...
4. **CN\_VERSION:**
   * The following is only used for certain decision logic. It is best to keep it aligned with the consensus node version you deploy or build locally, for example: `CN_VERSION: "v0.73.0"`
