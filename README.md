> 📝 Solo has a new quick-start command!  check it out: [Solo User Guide](https://solo.hiero.org/latest/docs/step-by-step-guide/#quick-start-deployment), [Solo CLI Commands](https://solo.hiero.org/latest/docs/solo-commands/#quick-start-single)
