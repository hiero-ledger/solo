...
export const MIRROR_NODE_VERSION: string = constants.getEnvironmentVariable('MIRROR_NODE_VERSION') || 'v0.140.0';
...
export const TRANSACTION_TOOL_VERSION: string =
  constants.getEnvironmentVariable('TRANSACTION_TOOL_VERSION') || 'v0.16.1';
