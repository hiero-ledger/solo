...
export const HEDERA_PLATFORM_VERSION: string =
  constants.getEnvironmentVariable('CONSENSUS_NODE_VERSION') || 'v0.74.0-rc.1';
...
export const BLOCK_NODE_VERSION: string = constants.getEnvironmentVariable('BLOCK_NODE_VERSION') || '0.32.0';
...
export const MINIMUM_HIERO_PLATFORM_VERSION_FOR_AGREEMENT_GOSSIP_CERTS: string = '0.74.0-0';
