...
export class K8Client implements K8 {
  ...
  public init(context: Optional<string> = undefined): K8 {
    ...
    this.k8Pods = new K8ClientPods(this.kubeClient, this.kubeConfig, this.kubectlExecutable, this.prependToPath);
    this.k8Containers = new K8ClientContainers(this.kubeConfig, this.k8Pods, this.kubectlExecutable, this.prependToPath);
