...
import {DnfPackageManager} from '../package-managers/dnf-package-manager.js';
import {ZypperPackageManager} from '../package-managers/zypper-package-manager.js';
import {PacmanPackageManager} from '../package-managers/pacman-package-manager.js';
import {ApkPackageManager} from '../package-managers/apk-package-manager.js';
...
export class Container {
  ...
  private static singletonContainers(): SingletonContainer[] {
    return [
      ...
      new SingletonContainer(InjectTokens.DnfPackageManager, DnfPackageManager),
      new SingletonContainer(InjectTokens.ZypperPackageManager, ZypperPackageManager),
      new SingletonContainer(InjectTokens.PacmanPackageManager, PacmanPackageManager),
      new SingletonContainer(InjectTokens.ApkPackageManager, ApkPackageManager),
