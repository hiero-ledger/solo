...
/**
 * @description Thrown when the restore options file does not exist; the message names it. solo reads restore options
 * from this file, so this means it is missing or the path is wrong.
 */
