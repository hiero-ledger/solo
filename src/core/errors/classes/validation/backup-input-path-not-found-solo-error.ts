...
/**
 * @description Thrown when the backup input path does not exist; the message names it. solo reads the backup from this
 * path, so this means it is missing or the path is wrong.
 */
