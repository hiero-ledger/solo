...
/**
 * @description Thrown when a relay component id is not valid; the message includes the value and its runtime type. solo
 * expects component ids in a specific form, so this means the supplied id is malformed or of the wrong
 * type.
 */
