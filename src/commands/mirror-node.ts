              ...
              [
                ...
                },
                {
                  ...
                  task: async (context_): Promise<void> => {
                    ...
                    mirrorIngressControllerValuesArgument += ` --set fullnameOverride=${config.ingressReleaseName}`;
                    mirrorIngressControllerValuesArgument += ` --set controller.ingressClass=${config.ingressReleaseName}`;
                    mirrorIngressControllerValuesArgument += ` --set controller.extraArgs.controller-class=${config.ingressReleaseName}`;
        ...
        this.addMirrorNodeComponents(),
        {
          ...
          task: async context_ => {
            ...
            for (const pod of pods) {
              if (pod.podReference.name.name.startsWith('haproxy-ingress')) {
