...
export function buildDestroyExplorerArgv(config: OneShotSingleDestroyConfigClass): string[] {
...
export function buildDestroyRelayArgv(config: OneShotSingleDestroyConfigClass): string[] {
  const argv: string[] = newArgv();
  argv.push(
...
export function buildDestroyMirrorNodeArgv(config: OneShotSingleDestroyConfigClass): string[] {
  const argv: string[] = newArgv();
  argv.push(
...
export function buildDestroyBlockNodeArgv(config: OneShotSingleDestroyConfigClass): string[] {
  const argv: string[] = newArgv();
  argv.push(
...
export function buildDestroyConsensusNodeArgv(config: OneShotSingleDestroyConfigClass): string[] {
  const argv: string[] = newArgv();
  argv.push(
...
export function buildClusterResetArgv(config: OneShotSingleDestroyConfigClass): string[] {
  const argv: string[] = newArgv();
  argv.push(
...
export function buildClusterDisconnectArgv(config: OneShotSingleDestroyConfigClass): string[] {
  const argv: string[] = newArgv();
  argv.push(
...
export function buildDeploymentDeleteArgv(config: OneShotSingleDestroyConfigClass): string[] {
  const argv: string[] = newArgv();
  argv.push(
