 ...
 */
  ...
  public static readonly relayImage: CommandFlag = {
    constName: 'relayImage',
    name: 'relay-image',
    definition: {
      describe:
        'Full relay Docker image reference override (e.g. ghcr.io/org/image:tag, docker.io/library/redis:7, redis:7)',
      defaultValue: '',
      type: 'string',
    },
    prompt: undefined,
