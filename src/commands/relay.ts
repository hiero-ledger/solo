...
import {
  ...
  RELAY_MIRROR_NODE_GET_CONTRACT_RESULTS_DEFAULT_RETRIES,
  RELAY_MIRROR_NODE_RETRY_DELAY,
...
export class RelayCommand extends BaseCommand {
  ...
  private async prepareValuesArgForRelay({
    ...
    valuesArgument += ` --set relay.config.MIRROR_NODE_RETRY_DELAY=${RELAY_MIRROR_NODE_RETRY_DELAY}`;
    valuesArgument += ` --set relay.config.MIRROR_NODE_GET_CONTRACT_RESULTS_DEFAULT_RETRIES=${RELAY_MIRROR_NODE_GET_CONTRACT_RESULTS_DEFAULT_RETRIES}`;
