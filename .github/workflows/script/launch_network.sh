...
export CONSENSUS_NODE_VERSION=$(.github/workflows/script/extract-version.sh TEST_UPGRADE_FROM_VERSION version-test.ts)
...
export CONSENSUS_NODE_VERSION=$(.github/workflows/script/extract-version.sh HEDERA_PLATFORM_VERSION version.ts)
