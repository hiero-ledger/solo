...
describe('KubectlDependencyManager', (): void => {
  ...
  describe('when kubectl is installed globally', (): void => {
    ...
    beforeEach((): void => {
      ...
      runStub = sandbox.stub(kubectlDependencyManager, 'runExternalCommand');
  ...
  describe('KubectlDependencyManager system methods', (): void => {
    ...
    it('getVersion should succeed with valid version output', async (): Promise<void> => {
      sandbox.stub(kubectlDependencyManager, 'runExternalCommand').resolves(mockVersionOutputValid.split('\n'));
    ...
    it('getVersion should handle error if kubectl version fails', async (): Promise<void> => {
      sandbox.stub(kubectlDependencyManager, 'runExternalCommand').rejects(new Error('Command failed'));
    ...
    it('getVersion should handle invalid output', async (): Promise<void> => {
      sandbox.stub(kubectlDependencyManager, 'runExternalCommand').resolves(mockVersionOutputInvalid.split('\n'));
    ...
    it('getVersion should handle missing client version in output', async (): Promise<void> => {
      sandbox.stub(kubectlDependencyManager, 'runExternalCommand').resolves(mockVersionOutputMissingClient.split('\n'));
