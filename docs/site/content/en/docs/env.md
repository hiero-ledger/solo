...
| `BLOCK_NODE_VERSION`              | The [release version](https://github.com/hiero-ledger/hiero-block-node/releases) of the block node to use.                                                             | `v0.14.0`                                                                                          |
| `CONSENSUS_NODE_VERSION`          | The [release version](https://github.com/hiero-ledger/hiero-consensus-node/releases) of the consensus node to use.                                                            | `v0.63.9`                                                                                          |
